...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (start_time varchar, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar)
""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS times (start_time time, hour numeric, day numeric, week numeric, month numeric, year numeric, weekday numeric)
""")
